...
class CourseComment(models.Model):
    user = models.ForeignKey(UserProfile, on_delete=models.SET_DEFAULT, default=0, verbose_name='用户外键')
...
class UserCourse(models.Model):
    user = models.ForeignKey(UserProfile, on_delete=models.SET_DEFAULT, default=0, verbose_name='用户外键')
    course = models.ForeignKey(Course, on_delete=models.SET_DEFAULT, default=0, verbose_name='学习课程外键')
    created_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
    class Meta:
        verbose_name = '用户课程'
        verbose_name_plural = verbose_name
